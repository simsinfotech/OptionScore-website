      ...
      <nav className="sticky top-0 z-[1000] bg-black border-b border-[rgba(11,177,88,0.15)] py-3 md:py-4">
        <div className="w-full px-5 md:px-12 lg:px-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <Image src="/images/logo.png" alt="OptionScore" width={64} height={64} className="h-5 w-5 md:h-6 md:w-6" />
            <Image src="/images/logo-text.png" alt="OptionScore" width={320} height={56} className="h-3 md:h-3.5 w-auto" />
          </Link>

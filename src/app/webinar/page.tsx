...
export default function WebinarPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030a06] text-[#d1d5db] flex flex-col relative overflow-x-hidden">
      ...
      {/* ═══════════════════════════════════════════════════
         HERO — full-width dark bg, centered, massive text
         (mirrors selllikecrazy hero section exactly)
         ═══════════════════════════════════════════════════ */}
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-5 md:px-8 pt-10 md:pt-20 pb-12 md:pb-20 text-center">
          {/* Top badge — like selllikecrazy's "#1 BESTSELLER" badge */}
          ...
          {/* Star rating — like selllikecrazy's 4.9 out of 6072 */}
          ...
          {/* MASSIVE headline — like selllikecrazy's main h1 */}
          ...
          {/* VSL embed placeholder — like selllikecrazy's video */}
      ...
      {/* ═══════════════════════════════════════════════════
         EARLY PROOF — single strongest testimonial
         (like selllikecrazy's influencer quote strip)
         ═══════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════
         PAIN AGITATION — flowing sales letter copy
         (like Sabri's personal letter section)
         ═══════════════════════════════════════════════════ */}
      <section className="py-14 md:py-24">
        <div className="max-w-2xl mx-auto px-5 md:px-8">
          ...
          {/* CTA after pain section — selllikecrazy repeats CTA after every major section */}
          <CtaBlock className="mt-10 md:mt-14" />
        </div>
      </section>

      {/* ═══════════════════════════════════════════════════
         VISUAL PROOF STRIP — 3 chart frames
         (like selllikecrazy's product/result images)
         ═══════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════
         ...
         (like selllikecrazy's "Here's Just A Mere Fraction
         Of The Gold You'll Discover" section)
         ═══════════════════════════════════════════════════ */}
      <section className="py-14 md:py-24">
        <div className="max-w-2xl mx-auto px-5 md:px-8">
          ...
          {/* Bullet list — plain, like selllikecrazy's book content bullets */}
      ...
      {/* ═══════════════════════════════════════════════════
         AUTHORITY — Who's teaching this
         (like Sabri Suby's personal story section with photo)
         ═══════════════════════════════════════════════════ */}
      <section className="py-14 md:py-24 border-y border-[rgba(11,177,88,0.1)] bg-[rgba(0,0,0,0.3)]">
        <div className="max-w-2xl mx-auto px-5 md:px-8">
          ...
          {/* Photo + name — like selllikecrazy's author section */}
          ...
          {/* Flowing letter-style copy — like Sabri's story */}
          <div className="space-y-5 text-[0.92rem] md:text-[1.08rem] text-[#b0b0b0] leading-[1.8]">
            <p>
          ...
          {/* WhatsApp inline CTA — like selllikecrazy's inline CTAs */}
      ...
      {/* ═══════════════════════════════════════════════════
         SOCIAL PROOF WALL — testimonial quotes
         (like selllikecrazy's testimonial section with photos/quotes)
         ═══════════════════════════════════════════════════ */}
      <section className="py-14 md:py-24">
        <div className="max-w-2xl mx-auto px-5 md:px-8">
          <h2 className="font-extrabold text-[1.4rem] md:text-[2.4rem] text-white leading-[1.15] mb-10 md:mb-14 text-center uppercase tracking-tight">
          ...
          {/* Testimonials — flowing list, like selllikecrazy's stacked testimonials */}
      ...
      {/* ═══════════════════════════════════════════════════
         VALUE STACK + WHY ₹299 + GUARANTEE
         (like selllikecrazy's pricing/offer section)
         ═══════════════════════════════════════════════════ */}
      <section id="register" className="py-14 md:py-24 border-y border-[rgba(11,177,88,0.1)] bg-[rgba(0,0,0,0.3)]">
        <div className="max-w-2xl mx-auto px-5 md:px-8">
          ...
          {/* Value stack — like selllikecrazy's what's included list */}
          ...
          {/* Why so cheap — flowing copy like selllikecrazy's objection handling */}
          ...
          {/* Guarantee — like selllikecrazy's oath/guarantee section */}
          ...
          {/* Big pricing block + CTA — like selllikecrazy's offer box */}
      ...
      {/* ═══════════════════════════════════════════════════
         URGENCY — seat cap + countdown
         (like selllikecrazy's stock level indicator)
         ═══════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════
         FAQ
         (like selllikecrazy's FAQ section)
         ═══════════════════════════════════════════════════ */}
      <section className="py-14 md:py-24 border-y border-[rgba(11,177,88,0.1)] bg-[rgba(0,0,0,0.3)]">
        <div className="max-w-2xl mx-auto px-5 md:px-8">
          <h2 className="font-extrabold text-[1.4rem] md:text-[2.4rem] text-white leading-[1.15] mb-10 md:mb-14 text-center uppercase tracking-tight">
      ...
      {/* ═══════════════════════════════════════════════════
         FINAL CTA — closing argument + last button
         (like selllikecrazy's final section)
         ═══════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════
         FOOTER — compliance disclaimer only (no nav links except legal)
         ═══════════════════════════════════════════════════ */}
      ...
      {/* ═══════════ Sticky Bottom Bar (mobile — like selllikecrazy's persistent CTA) ═══════════ */}

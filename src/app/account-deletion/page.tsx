  ...
  return (
    <div className="min-h-screen bg-background grid-bg">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        ...
        >
          <h1 className="font-bold tracking-normal text-3xl md:text-4xl text-text-primary mb-4">
          ...
          <div className="bg-card border border-card-border p-6 mb-10">
            <h2 className="font-bold tracking-normal text-base text-text-primary mb-4">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label
                  htmlFor="email"
                  className="block text-sm font-semibold uppercase tracking-normal text-text-primary mb-2"
                >
                  Account Email
                </label>
                <input
            ...
            >
              ...
              <h2 className="font-bold tracking-normal text-xl text-text-primary mb-3">
                Request Submitted
              </h2>

    ...
    >
      ...
      <div className="relative z-[10] w-full mx-auto px-6 lg:px-20 py-20 md:py-32 text-center overflow-hidden">
        ...
        <div className="hidden md:flex mt-20 items-end justify-center gap-10">
          ...
          >
            <PhoneMockup src="/images/preview-2.webp" alt="OptionScore market overview" className="w-[200px]" />
          </motion.div>
          ...
          >
            <PhoneMockup src="/images/preview-1.webp" alt="OptionScore command center" className="w-[260px]" />
          </motion.div>
          ...
          >
            <PhoneMockup src="/images/preview-3.webp" alt="OptionScore options intelligence" className="w-[200px]" />
          </motion.div>
        </div>
        ...
        <div className="md:hidden mt-12 -mx-6">
          <div ref={sliderRef} className="flex gap-4 overflow-x-auto snap-x snap-mandatory px-[calc(50vw-90px)] pb-4 scrollbar-hide">
            ...
            >
              <PhoneMockup src="/images/preview-2.webp" alt="OptionScore market overview" className="w-[180px]" />
            </motion.div>
            ...
            <motion.div
              ...
              className="flex-shrink-0 snap-center"
            >
              <PhoneMockup src="/images/preview-1.webp" alt="OptionScore command center" className="w-[180px]" />
            </motion.div>
            ...
            <motion.div
              ...
              className="flex-shrink-0 snap-center"
            >
              <PhoneMockup src="/images/preview-3.webp" alt="OptionScore options intelligence" className="w-[180px]" />
            </motion.div>
          </div>
        </div>
      </div>

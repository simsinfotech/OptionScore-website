...
export const WORKSHOP = {
  ...
  experienceCards: [
    ...
    },
    {
      ...
      items: [
        "Live market open on Nifty, Bank Nifty, or XAUUSD",
    ...
    },
    {
      ...
      items: [
        ...
        "Specific feedback on what you read right and where you drifted",
